...
\Cref{tab:pwall} records the computed values. The default parameters do not
close at fixed area at the nominal hour, so the common anchor is the fold mass,
and the $p=1$ entry is $\tfrac32 t_f$ as the remark predicts.
